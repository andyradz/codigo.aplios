 ...
 * podstawie algorytmu przez wstawianie.
 *
 * Algorytm sortowania przez wstawianie jest uważany za bardzo zły algorytm
...
public final class InsertionSorter<T> extends AbstractSorter<T> {
	 ...
	 */
	public InsertionSorter(final Comparator<T> comparator) {
	 ...
	 */
	public InsertionSorter(final Comparator<T> comparator, final SortingOrder sortingMode) {
