 ...
 */
public final class CoctailSorter<T>
     ...
     */
    public CoctailSorter(final Comparator<T> comparator) {
     ...
     */
    public CoctailSorter(final Comparator<T> comparator, final SortingOrder sortingMode) {
