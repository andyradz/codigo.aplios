...
public class MostPopular<T>
        implements Collector<T, Map<T, Integer>, Optional<T>> {
    ...
    public static void main(final String[] args) {
        ...
        final List<Integer> integers = Arrays.asList(1, 1, 2, 2, 2, 3, 4, 5, 5, 5, 5, 5, 5, 5, 34, 34, 34, 324, 4, 4,
                422, 121, 23, 1, 1, 1, 1, 1, 1, 1, 1, 1);
        final List<Character> characters = Arrays.asList('a', 'b', 'c', 'c', 'c', 'd', 'a', 'b', 'c', 'c', 'c', 'd',
                'a', 'b', 'c', 'c', 'c', 'd', 'a', 'b', 'c', 'c', 'c', 'd');
     ...
     * @param list
     */
    private static <T> void showMostPopular(final List<T> list) {

        final Optional<T> o = list.stream().
