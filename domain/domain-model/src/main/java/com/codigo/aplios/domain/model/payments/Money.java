package com.codigo.aplios.domain.model.payments;
...
public final class Money
     ...
     *
     * @param amount
     *                     is required, can be positive or negative. The number of decimals in the amount cannot <em>exceed</em> the
     *                     maximum number of decimals for the given {@link Currency}. It's possible to create a <tt>Money</tt> object
     *                     in terms of 'thousands of dollars', for instance. Such an amount would have a scale of -3.
     * @param currency
     *                     is required.
     * @param roundingMode
     ...
     *
     * @param moneys
     *                        collection of <tt>Money</tt> objects, all of the same currency. If the collection is empty, then a zero
     *                        value is returned.
     * @param currencyIfEmpty
     *                        is used only when <tt>aMoneys</tt> is empty; that way, this method can return a zero amount in the desired
     *                        currency.
     */
