...
public class CsvFileRead {
	...
	private static void readStreamOfLinesUsingFilesWithTryBlock() throws IOException {
		...
		// "c://windows/csup.txt";
		final String fileName = "D:/kdpw.source/rationalsdp/workspace/.metadata/.plugins/com.ibm.etools.iseries.edit/information/44P755J.nsdrtest_5Fobjects10.250.50.129_3AMECADEV_2FQRPGLESRC(ECANTF03MG).xml";
		...
		for (final String string : CsvFileRead.context)
