...
/**
 * Klasa zawiera metody pomocnicze do obsługi dowolnego typu wyliczeniowego. Realizuje najczęściej
 * potrzebne operacje wykonywane na dowolnym typie wyliczeniowym.
 *
...
public final class EnumOperator {
	 ...
	 *        Klasa typu wyliczeniowego
	 * @param name
	 *        Nazwa elementu wyliczeniowego szukanego w klasie typu wyliczeniowego
	 * @return Wartość true typ wyliczeniowy zawiera element o takiej nazwie, wartość false brak
	 *         elementu o takiej nazwie w typie wyliczeniowy. Metoda nie jest wrażliwa na wielkośc
	 *         znaków.
	 */
	...
	/**
	 * Metoda pobiera wskazany element typu wyliczeniowego na podstawie wskazanej nazwy. Metoda nie jest
	 * wrażliwa na wielkość znaków.
	 *
	 * @param type
	 *        Klasa typu wyliczeniowego
	 * @param name
