...
public final class RgbToHslColorConverter {
	...
	public static RgbToHslColorConverter of(int rgbColor) {

		return new RgbToHslColorConverter(rgbColor);
	}

	public static RgbToHslColorConverter of(int rgbRed, int rgbGreen, int rgbBlue) {
	 ...
	 * @param rgbValue
	 */
	private RgbToHslColorConverter(int rgbValue) {
	 ...
	 */
	private RgbToHslColorConverter(int redValue, int greenValue, int blueValue) {
