...
public class EncryptDecryptProperty {
	...
	// methods
	// * for encryption and decryption job. After successful job the constructor puts the decrypted
	...
	// // Set the boolean flag to true to indicate future encryption operation that password is already
	// // encrypted
