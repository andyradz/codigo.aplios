...
public class TestsStringArrayIterator {
	...
	final String[] array = { "A", "B", "C", "D", "E", "F", "G", "H", "I", "J", "", "null" };
	...
	public void testShouldCount12_Of() {
		...
		final ArrayIterable<String> iterator = ArrayIteratorFactory.of(this.array);
	...
	public void testShouldCount1_OfRangeFirst_To_First() {
		...
		final ArrayIterable<String> iterator = ArrayIteratorFactory.ofRange(this.array, 0, 0);
		System.out.println(iterator);
	...
	public void testShouldCount1_OfRangeLast_To_Last() {
		...
		final ArrayIterable<String> iterator = ArrayIteratorFactory.ofRange(this.array, 11, 11);
		System.out.println(iterator);
	...
	public void testShouldCount9_OfRangeOne_To_Nine() {
		...
		final ArrayIterable<String> iterator = ArrayIteratorFactory.ofRange(this.array, 1, 9);
		System.out.println(iterator);
	...
	public void testShouldCount1_OfCount_One() {
		...
		final ArrayIterable<String> iterator = ArrayIteratorFactory.ofCount(this.array, 1);
		System.out.println(iterator);
	...
	public void testShouldCount1_OfFrst_Ten() {
		...
		final ArrayIterable<String> iterator = ArrayIteratorFactory.ofFirst(this.array, 10);
		System.out.println(iterator);
	...
	public void testShouldCount6_OfLast_Five() {
		...
		final ArrayIterable<String> iterator = ArrayIteratorFactory.ofLast(this.array, 5);
		System.out.println(iterator);
