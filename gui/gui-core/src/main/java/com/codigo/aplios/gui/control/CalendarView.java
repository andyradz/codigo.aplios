...
public class CalendarView
    ...
    /**
     * Initializes a calendar with the given locale. E.g. if the locale is en-US,
     * the calendar starts the days on Sunday. If it is de-DE the calendar starts
     * the days on Monday.
     * <p/>
     ...
     * <p/>
     * This way, you can pass a custom calendar (e.g. you could implement the Hijri
     * Calendar for the arabic world). Or you can use an American style calendar
     * (starting with Sunday as first day of the week) together with another
     * language.
     * <p/>
    ...
    public CalendarView(final Locale locale, final Calendar calendar) {
        ...
        this.calendarDate
                .addListener((InvalidationListener)observable ->
                        calendar.setTime(CalendarView.this.calendarDate.get()));
        ...
        this.getChildren()
                .addAll(this.mainNavigationPane, mainStackPane);
    ...
    /**
     * Counts the current transitions. As long as an animation is going, the panels
     * should not move left and right.
     */
