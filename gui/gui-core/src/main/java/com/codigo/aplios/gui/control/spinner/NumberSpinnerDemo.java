...
public class NumberSpinnerDemo extends Application {
	...
	public void start(Stage primaryStage) {
		...
		final NumberSpinner decimalFormat = new NumberSpinner(BigDecimal.ZERO,
				new BigDecimal("0.05"),
				new DecimalFormat("#,##0.00"));
		final NumberSpinner percent = new NumberSpinner(BigDecimal.ZERO,
				new BigDecimal("0.01"),
				NumberFormat.getPercentInstance());
		final NumberSpinner localizedCurrency = new NumberSpinner(BigDecimal.ZERO,
				new BigDecimal("0.01"),
		...
		String path = NumberSpinnerDemo.class.getResource("number_spinner.css")
				.toExternalForm();
