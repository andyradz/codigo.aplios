...
public class DatePicker
    ...
    public DatePicker(final Locale locale) {
        ...
        this.calendarView.currentDateProperty()
                .bind(this.selectedDateProperty());
        ...
        this.localeProperty()
                .addListener((InvalidationListener)observable -> DatePicker.this.updateTextField());
     ...
     * True, if the date should be set to null, when a {@link ParseException}
     * occurs. This is the case, when the text field loses focus.
     */
    private void tryParse(final boolean setDateToNullOnException) {
        ...
        try {
            ...
            final DateFormat dateFormat = this.getActualDateFormat();
            ...
            if ((this.selectedDate.get() == null) ||
                    ((this.selectedDate.get() != null) &&
                    (parsedDate.getTime() != this.selectedDate.get()
                    .getTime())))
    ...
    private void updateTextField() {
        ...
        if (this.selectedDateProperty()
                .get() != null) {
            final String date = this.getActualDateFormat()
                    .format(this.selectedDateProperty()
                            .get());
    ...
    /**
     * The prompt text for the text field. By default, the prompt text is taken from
    ...
    private void showPopup() {
        ...
        final double posX = calendarBounds.getMinX() +
                bounds.getMinX() + this.getScene()
                .getX() +
                this.getScene()
                        .getWindow()
                        .getX();
        final double posY = calendarBounds.getMinY() +
                bounds.getHeight() + bounds.getMinY() + this.getScene()
                .getY() +
                this.getScene()
                        .getWindow()
                        .getY();
