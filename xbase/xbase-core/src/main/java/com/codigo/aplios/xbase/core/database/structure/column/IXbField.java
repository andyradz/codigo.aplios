...
class XbField implements IXbField {
	...
	protected static IXbField createField(final DataInput data, final Charset charset) {

		return new XbField();
	}

	protected void write(final DataOutput out, final Charset charset) throws IOException {
	...
	protected static IXbField createField(final byte[] data, final Charset charset) {
	...
	public XbField(final String fieldName, final XbFieldType fieldType) {
	...
	public XbField(final String fieldName, final XbFieldType fieldType, final int fieldSize) {
	...
	public XbField(final String fieldName, final XbFieldType fieldType, final int fieldSize,
			final int fieldDecimalPlaces) {

		// TODO: inialize
	}

	public XbField(final XbField origin) {
