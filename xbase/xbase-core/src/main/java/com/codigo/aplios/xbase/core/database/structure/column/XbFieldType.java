...
/**
 * Klasa typu wyliczeniowego zawiera znaczniki reprezentujace typy danych standardu XBase.
 *
...
public enum XbFieldType {
    ...
    UNKNOWN((byte)0),
    /**
     * Typ znakowy, typ doplniony pustymi znakami
     */
    ...
    private XbFieldType(final byte code, final int minSize, final int maxSize, final int defaultSize,
