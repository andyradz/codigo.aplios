...
/**
 * Klasa realizuje mechanizm kodowania i dekodowania znaków dla standardu Kamenicky. Zawiera
 * implementacje interfejsu <code>Charset</code> będacego podstawa dla standardu kodowania znaków.
 *
 * Przykład użycia: <code>Charset.forName("KAMENICKY")</code>
 *
...
public class KamenickyCharset extends Charset {
	...
	public class KamenickyCharsetEncoder extends CharsetEncoder {
		...
		protected CoderResult encodeLoop(final CharBuffer in, final ByteBuffer out) {
			...
			while (in.hasRemaining()) {
				...
				for (final char[] element : KamenickyCharset.CHARSET)
	...
	public class KamenickyCharsetDecoder extends CharsetDecoder {
		...
		/**
		 * Podstawowy konstruktor obiektu klasy <code>KamenickyCharsetDecoder</code>
		 *
		 * @param cs
