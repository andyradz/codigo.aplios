...
public enum XbCodePages {
	...
	/**
	 * Metoda sprawdza i wyszukuje czy obsługuje daną stronę kodową. W przypadku braku obsługi
	 * ustawianie jest domyślne kodowanie ASCII.
	 *
	 * @param codepage
	...
	/**
	 * Metoda sprawdza i wyszukuje czy obsługuje wskazany rodzaj kodowania znaków. W przypadku braku
	 * obsługi ustawiana jest domyślna strona kodowa o numerze 0.
	 *
	 * @param charset
	 *        Rodzaj kodowania znaków
