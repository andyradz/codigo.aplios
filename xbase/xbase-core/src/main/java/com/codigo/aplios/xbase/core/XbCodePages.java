...
/**
 * Typ wyliczeniowy reprezentuje mapowanie strony kodowej zbioru XBase na rodzaj kodowania Charset dostępnego w JRE. Typ
 * posiada mechanizm wyszukiwania dla strony kodowej odpowiedniego rodzaju kodowania znaków. Typ posiada mechanizm
 * wyszukiwania dla rodzaju kodowania znaków odpowiedniej strony kodowej. W przypadku braku strony kodowej lub rodzaju
...
public enum XbCodePages {
     ...
     */
    // KAMENICKY(Charset.forName("895"), 0x68),

    /**
     * Mazovia (Polish) MS-DOS
     */
    // MAZOVIA(Charset.forName("620"), 0x69),
    ...
    /**
     * Atrybut określa numery stron kodowych mapowane na danych zbiór znaków
     */
    private final int[] codepages;

    /**
     * Atrybut określa sposób kodowanych znaków
     */
     ...
     * @param codepages
     *                  Numery stron kodowych dla kodowania znaków
     */
    ...
    /**
     * Metoda sprawdza i wyszukuje czy obsługuje daną stronę kodową. W przypadku braku obsługi ustawianie jest domyślne
     * kodowanie ASCII.
     *
     * @param codepage
    ...
    /**
     * Metoda sprawdza i wyszukuje czy obsługuje wskazany rodzaj kodowania znaków. W przypadku braku obsługi ustawiana
     * jest domyślna strona kodowa o numerze 0.
     *
     * @param charset
     *                Rodzaj kodowania znaków
     * @return Numser strony kodowej
     */
    public static int ofCharset(@NonNullDecl final Charset charset) {
