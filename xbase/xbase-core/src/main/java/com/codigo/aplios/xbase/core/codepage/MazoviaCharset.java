...
/**
 * Klasa realizuje mechanizm kodowania i dekodowania znaków dla standardu Mazovia. Zawiera
 * implementacje interfejsu <code>Charset</code> będacego podstawa dla standardu kodowania znaków.
 *
...
public final class MazoviaCharset extends Charset {
	 ...
	 *
	 * @param canonicalName
	 *        Zformalizowana nazwa standadu kodowania znaków
	 * @param aliases
	 *        Aliasy nazw dla standardu kodowania Mazovia
	 */
	...
	private final class MazoviaCharsetEncoder extends CharsetEncoder {
		 ...
		 *
		 * @param cs
		 *        Podstawowy standard kodowania znaków
		 * @param averageBytesPerChar
		 *        Średnia wartość utworzonych znaków przez dekoder dla pojedeyńczego dekodowanego bajtu
		 * @param maxBytesPerChar
		 *        Maksymalna ilość znaków do zdekodowania z pojedyńczego bajtu
		 * @param replacement
		 *        Obszar zamiany kodowanej wartości
		 */
	...
	private final class MazoviaCharsetDecoder extends CharsetDecoder {
		 ...
		 *
		 * @param cs
		 *        Podstawowy standard kodowani znaków
