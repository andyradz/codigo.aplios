...
/**
 * Klasa realizuje operacje na liczbach rzeczywistych. File name : NumberHelper.java Create date :
 * 2016-12-06
 *
...
public class NumberHelper {
	...
	/**
	 * Znacznik wyraża precyzję części umałkowej wartości liczby rzeczywistej, która będzie brana pod
	 * uwagę podczas operacji arytmetycznych.
	 */
	public enum DecimalPrecision {
		 ...
		 *
		 * @param precision
		 *        Wartość liczbowa wyrażona w postaci liczby rzeczywsitej. Określa ilość pozycji części
		 *        ułamka wartości rzeczywistej, która będzie brana pod uwagę podczas obliczeń
		 *        arytmetycznych.
		 */
		...
		/**
		 * Właściwość obiektu określa precyzję ilości miejsc po przecinku, do której będzie sprowadzało się
		 * zaokrąglenie wartości liczby rzeczywistej.
		 *
		...
		public enum Round {
			...
			/**
			 * Metoda funktora dokonuje zaaokrąglenia wartosci liczby rzeczywistej do wskazanej precyzji.
			 */
			private final Function<Double, Double> doRound = (number) -> {
				...
				final double range = 0d;//// Math.pow(1E1, this.precision);
			...
			/**
			 * Metoda dokonuje wyznaczenia ułamka liczby rzeczywistej z uwzględnieniem precyzji zaokrąglenia.
			 *
			 * @param number
			 *        Wartość liczby rzeczywistej.
			 * @return Wartość numeryczna wyrażona liczbą rzeczywistą.
			 */
			public double evalue(final double number) {
	...
	/**
	 * Funkcja zwraca wartość ułamka liczby rzeczywistej z możliwością zastosowania zaaokrąglenia tej
	 * wartość do wskazanej dokładności.
	 *
	 * @param number
	 *        Wartość liczby rzeczywistej.
	 * @param precision
